...
%
% Answer: Clear All will delete everything that is in the workspace.
%
...
% averageAnswer.
% I would use the mean function to find the average of these numbers.
...
% I would use the VER command to list all installed toolboxes. 
...
%
% Answer: Statistical ttest; v = ttest(x) 
% 
...
%
% Answer: While loop and a for Loop.  A for loop allows you to execute the
% commands for a specified amount of times.  A while loop will run a
% sequence of commands continuously. 
% 
...
%
% Answer: NaN means Not-a-Number.  NaN is a result of mathmatically
% undefined operations, such as dividing 0 by 0.
%
...
% hamster obeyed a terrified and not excessively terrified hamster.
%Why?
...
disp('Hello World')
text = input('What is the password > ', 's');
